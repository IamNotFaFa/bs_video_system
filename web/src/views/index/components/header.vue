<template>
  <div class="main-bar-view">
    ...
    <div class="right-view">
      ...
      <div>
        <a-drawer title="消息与通知" placement="right" :closable="true" :maskClosable="true" :visible="msgVisible" @close="onClose">
          <b>我的消息</b>
          ...
          <a-spin :spinning="loading" style="min-height: 200px">
            <div class="list-content">
              <div class="notification-view">
                <div class="list">
                  <div class="notification-item flex-view" v-for="item in admsgData">
                    <!---->
                    <div class="content-box" @click="toLink(item.link)" style="cursor: pointer;">
                      <div class="header">
                        <img :src="item.image" alt=""/>
                        <br /><br />
                        <span class="time">活动编号：{{ item.id }}</span>
                      </div>
                      <div class="time">
                        <p>创建时间：{{ getFormatTime(item.createTime, true) }}</p>
                      </div>
                    </div>
                  </div>
                </div>
...
<script setup lang="ts">
  ...
  import { listApi as adListApi } from '/@/api/ad';
